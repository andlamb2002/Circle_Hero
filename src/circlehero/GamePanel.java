...
*/
    ...
    public void displayResults(JPanel panel, int extraW) {
        ...
        TextLabel text1 = new TextLabel("Score: " + score, 30, Color.black);
        TextLabel text2 = new TextLabel("Circles Clicked: " + totalCirclesHit, 30, Color.black);
        TextLabel text3 = new TextLabel("Total Clicks: " + mouseClicks, 30, Color.black);
        TextLabel text4 = new TextLabel("Accuracy: " + accuracy + "%", 30, Color.black);
    ...
    public void displayCircleCounter(JPanel panel, int extraW) {
        ...
        TextLabel counter = new TextLabel("Counter: " + totalCirclesHit + "/" + totalCircles, 30, Color.black);
    ...
    public void displayHighScore(JPanel panel, int extraW) {
        ...
        TextLabel text1 = new TextLabel("High Score: " + highScore, 30, Color.black);
