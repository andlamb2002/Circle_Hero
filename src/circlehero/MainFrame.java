...
public class MainFrame extends JFrame implements ActionListener, MouseListener, KeyListener, ChangeListener{
    ...
    private final int mainPanelWidth = 960;
    private final int mainPanelHeight = 720;
    static int extraWidth;
    private int extraHeight;
    private final int topPanelHeights = 200;
    private final int selectionSettingPanelWidth = 500;
    ...
    public MainFrame() {
        ...
        selectionSettingsPanel.add(new BasicPanel(0, 0, 200, 100).add(new TextLabel("Circle Size: ", 30, Color.black)));
        Integer circleSizeList[] = {80, 48, 60, 120, 240};
        ...
        selectionSettingsPanel.add(new BasicPanel(0, 100, 200, 100).add(new TextLabel("Total: ", 30, Color.black)));
        totalCirclesSlider = new JSlider(20, 100, 50);
        totalCirclesSlider.setPreferredSize(new Dimension(250, 50));
        ...
        totalCirclesLabel.setFont(new Font("VERDANA", Font.PLAIN, 30));
        selectionSettingsPanel.add(totalCirclesSlider);
        selectionSettingsPanel.add(totalCirclesLabel);
        
        //Game Mode Combo Box
        selectionSettingsPanel.add(new BasicPanel(0, 0, 200, 100).add(new TextLabel("Game Mode: ", 30, Color.black)));
        ...
        playButton.setBounds(355, 185, 250, 150);
        playButton.setFocusable(false);
        playButton.setFont(new Font("VERDANA", Font.BOLD, 50));
        ...
        settingsButton.setBounds(355, 385, 250, 150);
        settingsButton.setFocusable(false);
        settingsButton.setFont(new Font("VERDANA", Font.BOLD, 30));
        ...
        quitButton.setBounds((extraWidth - 150), 50, 100, 100);
        quitButton.setVisible(false);
        quitButton.setFocusable(false);
        quitButton.setFont(new Font("VERDANA", Font.BOLD, 30));
